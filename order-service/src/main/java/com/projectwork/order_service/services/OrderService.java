...
public class OrderService {
    ...
    public void paymentStatus() {
        ...
        String payment = orderList.get(orderList.size()-1).getPaymentStatus();
        Long id = orderList.get(orderList.size()-1).getId();
        System.out.println(payment);
        orderRepository.findById(id).get().setPaymentStatus("Successful");
        payment = orderList.get(orderList.size()-1).getPaymentStatus();
        System.out.println(payment);
